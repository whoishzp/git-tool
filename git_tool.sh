...
if [[ $1 == 'c' ]]; then
  ...
  if [[ $2 == "" ]];then
     ...
     git commit -m "提交改动" *
     echo -e "\033[35m======================【git pull origin master】=====================\033[0m"
     git pull origin master
     echo -e "\033[35m======================【git push origin $localBranch】=====================\033[0m"
     git push origin $localBranch
     echo -e "\033[35m======================【提交结束】=====================\033[0m"
     exit
  fi
  ...
  git commit -m "提交改动" *
  git push origin $localBranch
  echo -e "\033[35m======================【git checkout $2】=====================\033[0m"
  git checkout $2
  echo -e "\033[35m======================【git pull origin $2】=====================\033[0m"
  git pull origin $2
  echo -e "\033[35m======================【git pull origin master】=====================\033[0m"
  git pull origin master
  echo -e "\033[35m======================【git push origin $2】=====================\033[0m"
  git push origin $2
  echo -e "\033[35m======================【切换分支成功】=====================\033[0m"
  exit
fi
